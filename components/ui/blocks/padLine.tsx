...
import { getSemanticLineColors, type SemanticLineColors } from '../../../constants/theme';
...
function createStyles(c: SemanticLineColors) {
...
export const PadLine: React.FC<PadLineProps> = ({
  number = 0,
  type = 'Сигнал прохода',
  onPress,
}) => {
  ...
  const styles = useMemo(
    () => createStyles(getSemanticLineColors(scheme)),
    [scheme],
  );
